...
const HostCard = ({ host }) => {
  ...
  return (
    <div className={`group bg-gradient-to-br from-gray-800/90 to-gray-900/70 dark:from-gray-800/90 dark:to-gray-900/70 backdrop-blur-xl border rounded-lg shadow-lg transition-all duration-300 hover:shadow-2xl hover:shadow-white/5 dark:hover:shadow-white/5 hover:-translate-y-1 ${getLayerClasses(layerColor)}`}>
      <div 

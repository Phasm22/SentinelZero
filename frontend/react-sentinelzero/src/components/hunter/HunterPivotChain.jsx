  ...
  return (
    <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/60 backdrop-blur-lg border border-white/10 rounded-md shadow-xl p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="text-sm font-semibold text-gray-200">Pivot Chain</h3>
        ...
        {events.map((event) => (
          ...
          >
            <div className="flex items-center gap-2 text-gray-300">
              ...
              <span className="font-semibold text-gray-100">{event.type}</span>
              {event.ip && <span className="font-mono text-gray-400">{event.ip}</span>}
            </div>

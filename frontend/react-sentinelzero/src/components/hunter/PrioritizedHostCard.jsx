...
const PrioritizedHostCard = ({ host }) => {
  ...
  return (
    <div
      className={`group bg-gradient-to-br from-gray-800/90 to-gray-900/70 backdrop-blur-xl border border-white/10 border-l-4 ${tier.accent} rounded-lg shadow-lg transition-all duration-300 hover:shadow-2xl`}
    >
      <button
        type="button"
